...
1. **Local Claude Code CLI** (preferred)
2. **Other local CLIs** (Gemini CLI, Qwen CLI, etc.)
3. **Local lightweight LLMs (Ollama)**
4. **Cloud inference** (only if user opts in)
...
# **11. Monetization Model (If You Want to Build a Business)**
...
2. **The local + LLM intelligence**
3. **The IDE extension that connects everything to your real code**
